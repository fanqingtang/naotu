...
const teacherLess = new ExtractTextWebpackPlugin('css/teacher.css');
...
module.exports = {
    ...
    output: {
        filename: '[name].js',
        path: path.resolve('lexue3T/public/js/naotu')
    },
    module: {
        rules: [
            {
